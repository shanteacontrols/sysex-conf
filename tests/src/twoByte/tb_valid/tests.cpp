...
namespace
{
    ...
    SysExTestingValid sysEx(mId, SysExConf::paramSize_t::_14bit, SysExConf::nrOfParam_t::_32);
}    // namespace
...
TEST_CASE(GetSingle)
{
    ...
    TEST_ASSERT(static_cast<uint8_t>(SysExConf::status_t::ack) == sysEx.testArray[4]);
    TEST_ASSERT(0x00 == sysEx.testArray[5]);
    TEST_ASSERT(0x00 == sysEx.testArray[6]);
    TEST_ASSERT(TEST_VALUE_GET == sysEx.testArray[7]);
    TEST_ASSERT(0xF7 == sysEx.testArray[8]);
...
TEST_CASE(GetAll)
{
    ...
    TEST_ASSERT(0x00 == sysEx.testArray[8]);
    TEST_ASSERT(TEST_VALUE_GET == sysEx.testArray[9]);

    TEST_ASSERT(0x00 == sysEx.testArray[10]);
    TEST_ASSERT(TEST_VALUE_GET == sysEx.testArray[11]);

    TEST_ASSERT(0x00 == sysEx.testArray[12]);
    TEST_ASSERT(TEST_VALUE_GET == sysEx.testArray[13]);

    TEST_ASSERT(0x00 == sysEx.testArray[14]);
    TEST_ASSERT(TEST_VALUE_GET == sysEx.testArray[15]);

    TEST_ASSERT(0x00 == sysEx.testArray[16]);
    TEST_ASSERT(TEST_VALUE_GET == sysEx.testArray[17]);

    TEST_ASSERT(0x00 == sysEx.testArray[18]);
    TEST_ASSERT(TEST_VALUE_GET == sysEx.testArray[19]);

    TEST_ASSERT(0x00 == sysEx.testArray[20]);
    TEST_ASSERT(TEST_VALUE_GET == sysEx.testArray[21]);

    TEST_ASSERT(0x00 == sysEx.testArray[22]);
    TEST_ASSERT(TEST_VALUE_GET == sysEx.testArray[23]);

    TEST_ASSERT(0x00 == sysEx.testArray[24]);
    TEST_ASSERT(TEST_VALUE_GET == sysEx.testArray[25]);

    TEST_ASSERT(0xF7 == sysEx.testArray[26]);
...
TEST_CASE(CustomReq)
{
    ...
    TEST_ASSERT(0x00 == sysEx.testArray[6]);
    TEST_ASSERT(CUSTOM_REQUEST_VALUE == sysEx.testArray[7]);
    TEST_ASSERT(0xF7 == sysEx.testArray[8]);
...
TEST_CASE(SpecialRequest)
{
    ...
    TEST_ASSERT(static_cast<uint8_t>(SysExConf::status_t::ack) == sysEx.testArray[4]);
    TEST_ASSERT(0x00 == sysEx.testArray[5]);
    TEST_ASSERT(static_cast<uint8_t>(SysExConf::paramSize_t::_14bit) == sysEx.testArray[6]);
